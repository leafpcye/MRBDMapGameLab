...
| Location / Geolocation | Web standard; MRBD unknown | Injected calculations/browser precheck | Implemented for test | Not tested | Not tested | Implemented for test / MRBD result pending | Foreground, manual only |
